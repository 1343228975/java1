...
<div id="divcontent">
					...
					<tr>
						<c:forEach items="${pList }" var="pArray">
							<td style="width:80px; text-align:center">
								...
								<br/>
								<a href="${pageContext.request.contextPath}/FindProductByIdServlet?id=${pArray[0]}">${pArray[1]}</a>
									<%-- <br />作者:${pArray[2] } --%>
							</td>
						</c:forEach>
					</tr>
	...
	</table><a href="${pageContext.request.contextPath }/ShowIndexServlet">刷新一下</a>
</div>
