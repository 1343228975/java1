...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/client/js/form.js" charset=”gb2312″ ></script>
                ...
                <td style="padding: 30px"><h1>新用户注册</h1>
                    <table width="70%" border="0" cellspacing="2" class="upline">
                        <tr>
                            ...
                            <td colspan="2"><span id="emailMsg"></span><span color="#999999">请输入有效的邮箱地址</span></td>
                        </tr>
                        <tr>
                            <td style="text-align: right">用户名：</td>
                            <td><input type="text" class="textinput"  id="username" name="username" onkeyup="checkUsername();"/>
                            </td>
                            <td colspan="2"><span id="usernameMsg"></span><span color="#999999">字母数字下划线1到10位, 不能是数字开头</span></td>
                        </tr>
                        <tr>
                            <td style="text-align: right">密码：</td>
                            <td><input type="password" class="textinput"  id="password" name="password" onkeyup="checkPassword();"/></td>
                            <td><span id="passwordMsg"></span><span color="#999999">密码请设置6-16位字符</span></td>
                        </tr>
                        <tr>
